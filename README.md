// ELE8941 Robotics Lab 2 Part 2 May 29, 2026
void setup()
{
...
Serial.begin(9600);
delay(500);
Serial.println("Motor Test, Name: Steve Liu, Date: May 29, 2026");
}
void loop()
{
//Note to self: Don't forget to change back the Arduino pins to pin 2 (PWM) and 30 (DIR)
